...
/**
 * Menggambar UI toko di tengah layar.
...
public class StoreRenderer {
    ...
    public static void render(Graphics2D g, Store store, Player player) {
        ...
        // Scroll window agar item yang dipilih selalu terlihat
